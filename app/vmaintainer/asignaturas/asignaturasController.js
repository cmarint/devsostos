    ...
    return {
        getTodos: function()
        {
            ...
            $http({
                ...
                url: CONFIG.APISOSTOSBE + '/asignatura/get'
            }).then(function(res) {
        ...
        setAsi: function(registro)
        {
            ...
            $http({
                method: 'POST',
                //skipAuthorization: true,
                url: CONFIG.APISOSTOSBE + '/asignatura/upd',
                data: regjson,
            }).then(function(res) {
                deferred.resolve(res);
            }).then(function(error){
        ...
        addAsi: function(registro)
        {
            ...
            $http({
                method: 'POST',
                //skipAuthorization: true,
                url: CONFIG.APISOSTOSBE + '/asignatura/add',
                data: regjson
            }).then(function(res) {
                deferred.resolve(res);
            }).then(function(error){
        ...
        delAsi: function(id)
        {
            ...
            $http({
                method: 'GET',
                //skipAuthorization: true,
                url: CONFIG.APISOSTOSBE + '/asignatura/del/' + id
            }).then(function(res) {
                deferred.resolve(res);
            }).then(function(error){
                deferred.reject(error);
